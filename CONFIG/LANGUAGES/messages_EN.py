...
class Messages(object):
    ...
    ERROR1 = "No url link found. Please enter a url with <b>https://</b> or <b>http://</b>"
...
Contact me if you want me to allow your group to use my bots @andrey_stt
————————————
