...
class LoggerMsg(object):
    ...
    COOKIES_YOUTUBE_TEST_FAILED_ERROR_LOG_MSG = "YouTube cookies test failed on user URL for {cookie_file_path}: {e}"
    COOKIES_YOUTUBE_TEST_FAILED_NO_INFO_GENERAL_LOG_MSG = "YouTube cookies test failed - no info returned for {cookie_file_path}"
    COOKIES_YOUTUBE_TEST_FAILED_MISSING_FIELDS_LOG_MSG = "YouTube cookies test failed - missing fields: {missing_fields} for {cookie_file_path}"
    COOKIES_YOUTUBE_TEST_AVAILABLE_FIELDS_LOG_MSG = "Available fields: {fields}"
    COOKIES_YOUTUBE_TEST_FAILED_NO_FORMATS_LOG_MSG = "YouTube cookies test failed - no formats available for {cookie_file_path}"
    COOKIES_YOUTUBE_TEST_INFO_KEYS_LOG_MSG = "Info keys: {keys}"
    COOKIES_YOUTUBE_TEST_FAILED_TITLE_SHORT_LOG_MSG = "YouTube cookies test failed - title too short: '{title}' for {cookie_file_path}"
    COOKIES_YOUTUBE_TEST_TITLE_LENGTH_LOG_MSG = "Title length: {length}"
    COOKIES_YOUTUBE_TEST_FAILED_INVALID_DURATION_LOG_MSG = "YouTube cookies test failed - invalid duration: {duration} for {cookie_file_path}"
    COOKIES_YOUTUBE_TEST_DURATION_SECONDS_LOG_MSG = "Duration in seconds: {duration}"
    COOKIES_YOUTUBE_TEST_FAILED_TOO_FEW_FORMATS_LOG_MSG = "YouTube cookies test failed - too few formats: {formats_count} for {cookie_file_path}"
    COOKIES_YOUTUBE_TEST_AVAILABLE_FORMATS_LOG_MSG = "Available formats: {formats}"
    COOKIES_YOUTUBE_TEST_ALL_FORMAT_IDS_LOG_MSG = "All format IDs: {format_ids}"
    COOKIES_YOUTUBE_TEST_PASSED_LOG_MSG = "YouTube cookies test passed for {cookie_file_path} - {formats_count} formats available"
    COOKIES_YOUTUBE_TEST_TITLE_LOG_MSG = "Title: '{title}'"
    COOKIES_YOUTUBE_TEST_DURATION_LOG_MSG = "Duration: {duration}s"
    COOKIES_YOUTUBE_TEST_UPLOADER_LOG_MSG = "Uploader: {uploader}"
    ...
    COOKIES_YOUTUBE_TEST_LIKE_COUNT_LOG_MSG = "Like count: {like_count}"
    COOKIES_YOUTUBE_TEST_FORMAT_IDS_LOG_MSG = "Format IDs: {format_ids}"
    COOKIES_YOUTUBE_TEST_VIDEO_UNAVAILABLE_LOG_MSG = "YouTube test video is unavailable (not a cookie issue): {e}"
    COOKIES_YOUTUBE_TEST_AUTH_ERROR_LOG_MSG = "YouTube cookies test failed - authentication/format error: {e}"
    COOKIES_YOUTUBE_TEST_OTHER_ERROR_LOG_MSG = "YouTube cookies test - other error (may not be cookie-related): {e}"
    COOKIES_YOUTUBE_TEST_FAILED_EXCEPTION_LOG_MSG = "YouTube cookies test failed with exception: {e}"
    COOKIES_YOUTUBE_TEST_EXCEPTION_TYPE_LOG_MSG = "Exception type: {exception_type}"
    COOKIES_ERROR_SENDING_MESSAGE_LOG_MSG = "Error sending message to user: {e}"
    COOKIES_FINAL_FALLBACK_SEND_FAILED_LOG_MSG = "Final fallback send failed: {e}"
    COOKIES_YOUTUBE_URLS_EMPTY_LOG_MSG = "YouTube cookie URLs are empty for user {user_id}"
    COOKIES_ERROR_SENDING_INITIAL_LOG_MSG = "Error sending initial message: {e}"
    COOKIES_ERROR_UPDATING_MESSAGE_LOG_MSG = "Error updating message: {e}"
    COOKIES_YOUTUBE_ORDER_MODE_LOG_MSG = "YouTube cookie order mode: {order}"
    COOKIES_YOUTUBE_INDICES_ORDER_LOG_MSG = "YouTube cookie indices order: {indices}"
    COOKIES_YOUTUBE_FAILED_DOWNLOAD_LOG_MSG = "Failed to download YouTube cookie from URL {idx}: status={status}, error={err}"
    ...
    COOKIES_YOUTUBE_SOURCE_FAILED_LOG_MSG = "YouTube cookies from source {idx} failed validation"
    COOKIES_YOUTUBE_ERROR_PROCESSING_URL_LOG_MSG = "Error processing YouTube cookie URL {idx}: {e}"
    COOKIES_YOUTUBE_ALL_SOURCES_FAILED_LOG_MSG = "All YouTube cookie sources failed for user {user_id}"
    COOKIES_YOUTUBE_ERROR_LOGGING_LOG_MSG = "Error logging: {e}"
    COOKIES_YOUTUBE_USING_CACHED_LOG_MSG = "Using cached YouTube cookie validation result for user {user_id} (cache valid for {duration}s)"
    COOKIES_YOUTUBE_EXISTING_WORKING_LOG_MSG = "Existing YouTube cookies are working for user {user_id}"
    COOKIES_YOUTUBE_FINISHED_EXISTING_LOG_MSG = "Finished ensure_working_youtube_cookies for user {user_id} - existing cookies are working"
    COOKIES_YOUTUBE_NO_SOURCES_CONFIGURED_LOG_MSG = "No YouTube cookie sources configured for user {user_id}"
    ...
    COOKIES_YOUTUBE_FAILED_DOWNLOAD_SOURCE_LOG_MSG = "Failed to download YouTube cookie from URL {i}: status={status}, error={err}"
    COOKIES_YOUTUBE_URL_NOT_TXT_SOURCE_LOG_MSG = "YouTube cookie URL {i} is not .txt file"
    COOKIES_YOUTUBE_FILE_TOO_LARGE_SOURCE_LOG_MSG = "YouTube cookie file {i} is too large: {size} bytes"
    COOKIES_YOUTUBE_SOURCE_WORKING_LOG_MSG = "YouTube cookies from source {i} are working for user {user_id}"
    COOKIES_YOUTUBE_FINISHED_SOURCE_LOG_MSG = "Finished ensure_working_youtube_cookies for user {user_id} - working cookies found from source {i}"
    COOKIES_YOUTUBE_SOURCE_FAILED_VALIDATION_LOG_MSG = "YouTube cookies from source {i} failed validation for user {user_id}"
    COOKIES_YOUTUBE_ERROR_PROCESSING_SOURCE_LOG_MSG = "Error processing YouTube cookie URL {i} for user {user_id}: {e}"
    COOKIES_YOUTUBE_ALL_SOURCES_FAILED_REMOVE_LOG_MSG = "All YouTube cookie sources failed for user {user_id}, removing cookie file"
    COOKIES_YOUTUBE_FINISHED_NO_WORKING_LOG_MSG = "Finished ensure_working_youtube_cookies for user {user_id} - no working cookies found"
    COOKIES_YOUTUBE_ATTEMPTING_RETRY_PROXY_LOG_MSG = "Attempting to retry download with proxy for user {user_id}"
    COOKIES_YOUTUBE_RETRY_PROXY_SUCCESS_LOG_MSG = "Download retry with proxy successful for user {user_id}"
    COOKIES_YOUTUBE_RETRY_PROXY_FAILED_LOG_MSG = "Download retry with proxy failed for user {user_id}"
    COOKIES_YOUTUBE_RETRY_PROXY_ERROR_LOG_MSG = "Download retry with proxy failed for user {user_id}: {e}"
    COOKIES_YOUTUBE_ERROR_SETTING_PROXY_LOG_MSG = "Error setting up proxy retry for user {user_id}: {e}"
    COOKIES_YOUTUBE_RETRY_IN_PROGRESS_LOG_MSG = "Retry already in progress for user {user_id}, skipping to avoid infinite loop"
    COOKIES_YOUTUBE_ATTEMPTING_RETRY_COOKIES_LOG_MSG = "Attempting to retry download with different cookies for user {user_id}"
    COOKIES_YOUTUBE_NO_SOURCES_AVAILABLE_LOG_MSG = "No YouTube cookie sources available for retry for user {user_id}"
    COOKIES_YOUTUBE_RETRY_ORDER_LOG_MSG = "Retrying download with cookie sources in order: {indices}"
    COOKIES_YOUTUBE_RETRY_ATTEMPT_LOG_MSG = "Retry attempt {attempt}/{total} with cookie source {idx} for user {user_id}"
    COOKIES_YOUTUBE_RETRY_FAILED_DOWNLOAD_LOG_MSG = "Failed to download cookie from source {idx}: status={status}, error={err}"
    ...
    COOKIES_YOUTUBE_RETRY_FAILED_SOURCE_LOG_MSG = "Download retry failed with cookie source {idx} for user {user_id}"
    COOKIES_YOUTUBE_RETRY_FAILED_ERROR_LOG_MSG = "Download retry failed with cookie source {idx} for user {user_id}: {e}"
    COOKIES_YOUTUBE_RETRY_ERROR_COOKIE_RELATED_LOG_MSG = "Error is cookie-related, trying next source for user {user_id}"
    COOKIES_YOUTUBE_RETRY_ERROR_NOT_COOKIE_LOG_MSG = "Error is not cookie-related, stopping retry for user {user_id}"
    COOKIES_YOUTUBE_RETRY_SOURCE_FAILED_LOG_MSG = "Cookie source {idx} failed validation for user {user_id}"
    COOKIES_YOUTUBE_RETRY_ERROR_PROCESSING_LOG_MSG = "Error processing cookie source {idx} for user {user_id}: {e}"
    COOKIES_YOUTUBE_RETRY_ALL_SOURCES_FAILED_LOG_MSG = "All cookie sources failed for retry download for user {user_id}"
    COOKIES_YOUTUBE_CACHE_CLEARED_LOG_MSG = "Cleared all YouTube cookie validation cache"
    COOKIES_YOUTUBE_CACHE_CLEARED_USER_LOG_MSG = "Cleared YouTube cookie validation cache for user {user_id}"
    COOKIES_YOUTUBE_NO_CACHE_ENTRY_LOG_MSG = "No cache entry found for user {user_id}"
    ...
    IMG_BATCH_FAILED_DELETE_ORIGINAL_LOG_MSG = "[IMG BATCH] Failed to delete original {file_path}: {e}"
    ...
    IMG_BATCH_OTHERS_ZEROED_ORIGINAL_LOG_MSG = "[IMG BATCH OTHERS] Zeroed out original: {orig}"
    ...
    IMG_CLEANUP_FAILED_REMOVE_DIR_LOG_MSG = "[IMG CLEANUP] Failed to remove directory {dir_path}: {e}"
    IMG_CLEANUP_REMOVED_RUN_DIR_LOG_MSG = "[IMG CLEANUP] Removed empty run directory: {run_dir}"
    IMG_CLEANUP_FAILED_REMOVE_RUN_DIR_LOG_MSG = "[IMG CLEANUP] Failed to remove run directory {run_dir}: {e}"
    IMG_CLEANUP_COMPLETED_LOG_MSG = "[IMG CLEANUP] Final cleanup completed"
    IMG_CLEANUP_FAILED_LOG_MSG = "[IMG CLEANUP] Failed to perform final cleanup: {e}"
    IMG_ERROR_IN_COMMAND_LOG_MSG = "Error in image command: {e}"
    IMG_CLEANUP_ERROR_START_LOG_MSG = "[IMG CLEANUP ERROR] Starting final cleanup of user directory: {run_dir}"
    IMG_CLEANUP_ERROR_REMOVED_FILE_LOG_MSG = "[IMG CLEANUP ERROR] Removed file: {file_path}"
    IMG_CLEANUP_ERROR_FAILED_REMOVE_LOG_MSG = "[IMG CLEANUP ERROR] Failed to remove {file_path}: {e}"
    IMG_CLEANUP_ERROR_REMOVED_DIR_LOG_MSG = "[IMG CLEANUP ERROR] Removed empty directory: {dir_path}"
    IMG_CLEANUP_ERROR_FAILED_REMOVE_DIR_LOG_MSG = "[IMG CLEANUP ERROR] Failed to remove directory {dir_path}: {e}"
    IMG_CLEANUP_ERROR_REMOVED_RUN_DIR_LOG_MSG = "[IMG CLEANUP ERROR] Removed empty run directory: {run_dir}"
    IMG_CLEANUP_ERROR_FAILED_REMOVE_RUN_DIR_LOG_MSG = "[IMG CLEANUP ERROR] Failed to remove run directory {run_dir}: {e}"
    IMG_CLEANUP_ERROR_COMPLETED_LOG_MSG = "[IMG CLEANUP ERROR] Final cleanup completed"
    IMG_CLEANUP_ERROR_FAILED_LOG_MSG = "[IMG CLEANUP ERROR] Failed to perform final cleanup: {cleanup_final_e}"
    IMG_CLEANED_FILE_AFTER_ERROR_LOG_MSG = "Cleaned up file after general error: {file_path}"
    IMG_REMOVED_EMPTY_DIR_AFTER_ERROR_LOG_MSG = "Removed empty directory after general error: {root}"
    IMG_FILE_ALREADY_REMOVED_LOG_MSG = "File already removed after general error: {file_path}"
    IMG_FAILED_CLEANUP_FILE_LOG_MSG = "Failed to clean up file after general error {file_path}: {e}"
    IMG_FAILED_CLEANUP_AFTER_ERROR_LOG_MSG = "Failed to clean up downloaded files after general error: {cleanup_e}"
