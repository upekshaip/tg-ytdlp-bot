...
First fill in cookie.txt file. That cookie will be used by default for all users (you can paste YouTube cookie here).
...
`tg-ytdlp-bot/docker/configuration-webserver/site/cookies/cookie.txt`:
```
