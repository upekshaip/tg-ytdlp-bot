...
def get_language_keyboard(page=0, user_id=None, langs_override=None, per_page_rows=8):
    ...
    keyboard.append([
        ...
        InlineKeyboardButton(f"{auto_emoji} {messages.SUBS_AUTO_TRANS_BUTTON_MSG}", callback_data=f"subs_auto|toggle|{page}")
    ...
    keyboard.append([
        InlineKeyboardButton(f"{always_ask_emoji} {messages.SUBS_ALWAYS_ASK_BUTTON_MSG}", callback_data=f"subs_always_ask|toggle|{page}")
