...
"""
        ...
        if is_playlist and quality_key:
            ...
            send_to_logger(message, get_messages_instance().PLAYLIST_VIDEOS_SENT_LOG_MSG.format(sent=total_sent, total=len(requested_indices), quality=quality_key, user_id=user_id))
